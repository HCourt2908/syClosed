...
public class GameStateCreationTest extends ParameterisedModelTestBase {
	...
	@Test(expected = NullPointerException.class)		//complete
	...
	public void testAnyNullDetectiveShouldThrow() {		//complete
		gameStateFactory.build(standard24MoveSetup(),
				new Player(MRX, defaultMrXTickets(), 42),
	...
	@Test(expected = IllegalArgumentException.class)
	public void testEmptyMovesShouldThrow() {		//complete
	...
	@Test(expected = IllegalArgumentException.class)
	public void testEmptyGraphShouldThrow() {		//complete
		gameStateFactory.build(
